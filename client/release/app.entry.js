...
var socket = io();
var map;
var mapWorker = __webpack_require__(4);
var fullGeos;
...
var htmlWorker = __webpack_require__(23);
...
window.mainModule = {
    initMap() {
        ...
        let map = __webpack_require__(4).initialize();
        var socket = __webpack_require__(10)(map);
        __webpack_require__(24)(map);
        geolocationWorker = __webpack_require__(22)(map, socket);
